CREATE VIEW IF NOT EXISTS tezos_benchmark.ops_trx_summary_v
AS SELECT
    ops.name_of_chain AS exp_ID,

    -- total number of operations
    count(ops.op_hash) AS n_ops_exp,
    -- total number of confirmed transactions, i.e., operations included in a block
    countIf(ops.st_confirmed, ops.st_confirmed) AS n_trx_conf_exp,
    -- total number of propagated operations,
